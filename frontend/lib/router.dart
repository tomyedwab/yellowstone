...
List<GoRoute> createSubRoutes(
  ...
  return [
    GoRoute(
        path: 'list/:listId',
        builder: (context, state) => withResponsiveService(
            context,
            (responsiveService) => ResponsiveScaffold(
                  restDataService: dataService,
                  responsiveService: responsiveService,
                  selectedIndex: selectedIndex,
                  children: [
                    mainPage(responsiveService,
                        int.parse(state.pathParameters['listId']!)),
                    TaskListPage(
                      key: ValueKey(
                          'taskListPage-${state.pathParameters['listId']}-${state.pathParameters['taskId']}'),
    ...
    routes: [
      GoRoute(
        ...
        routes: createSubRoutes(
            dataService,
            0,
            (responsiveService, selectedListId) => ToDoListsPage(
                dataService: dataService,
      ...
      GoRoute(
        ...
        routes: createSubRoutes(
            dataService,
            1,
            (responsiveService, selectedListId) => LabelsPage(
                dataService: dataService,
                selectedListId: selectedListId,
                responsiveService: responsiveService),
            '/labels/'),
      ...
      GoRoute(
        ...
        routes: createSubRoutes(
            dataService,
            2,
            (responsiveService, selectedListId) => TemplatesPage(
                dataService: dataService,
                selectedListId: selectedListId,
                responsiveService: responsiveService),
            '/templates/'),
      ...
      GoRoute(
        ...
        routes: createSubRoutes(
            dataService,
            3,
            (responsiveService, selectedListId) => ArchivedListsPage(
                dataService: dataService,
                selectedListId: selectedListId,
                responsiveService: responsiveService),
            '/archived/'),
